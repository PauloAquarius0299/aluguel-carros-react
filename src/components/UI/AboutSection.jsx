            ...
            <Container>
                <Row>
                    ...
                    <div className='about__section-content'>
                        ...
                        <h2 className='section__title'>Bem Vindo ao Aluguel de Carros</h2>
                ...
                sunt.
                        ...
                        <div className='about__section-time d-flex align-items-center'>
                    ...
                    <Col lg='6' md='6'>
                        <div className='about__img'>
                            <img src={aboutImg} alt='about imagem bmw' className='w-100'  />
                        </div>
                    </Col>
                </Row>
            </Container>
